...
export const ARP_PATTERNS: ArpPattern[] = [
  ...
  },
  {
    ...
    seq: [["p"], ["i"], ["m"], ["a"], [], [], [], []],
    songs: "가족사진 (김진호)",
    note: "p·i·m·a 네 번을 8분음표로 뜯고, 3·4박은 줄을 누른 채 길게 울립니다. 빈 칸은 울리는 자리입니다. 베이스가 6번줄인 코드(G·F 등)는 1번줄을 쓰지 않고 6·4·3·2번줄로 뜯습니다 — 「가족사진」은 앞부분(44마디까지)의 가사가 있는 마디가 이 모양이고, 가사가 없는 마디와 45마디부터 끝까지는 a 다음 3박에 m을 한 번 더 이어 뜯어 다섯 번이 고르게 갑니다.",
    extra: true,
    lowOnSixth: true,
  },
  {
    no: 15, chords: ["G"],
    seq: [["p", "i", "m", "a"], ["p"], ["p"], ["p", "i", "m", "a"], ["p"], ["p"], ["p", "i", "m", "a"], ["p"]],
    songs: "힘 있는 후렴 반주",
    note: "엄지가 베이스를 8분음표로 계속 짚고, 1박·2박 반·4박(3+3+2)에 코드를 함께 튕기는 당김 패턴입니다.",
    extra: true,
  },
];
