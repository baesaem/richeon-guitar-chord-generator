...
export const ARP_PATTERNS: ArpPattern[] = [
  ...
  },
  {
    ...
    seq: [["p"], ["i"], ["m"], ["a"], [], ["m"], [], []],
    songs: "가족사진 (김진호)",
    note: "p·i·m·a 네 번을 8분음표로 뜯고, 3박은 울리게 둔 뒤 3박 반에 m으로 한 번만 더 뜯습니다. 빈 칸은 울리는 자리입니다 — 「가족사진」 노래 부분 반주가 이 모양이고, 전주에서는 그 한 번을 쉬지 않고 3박에 이어 뜯어 다섯 번이 고르게 갑니다.",
    extra: true,
  },
  {
    no: 15, chords: ["G"],
    seq: [["p", "i", "m", "a"], ["p"], ["p"], ["p", "i", "m", "a"], ["p"], ["p"], ["p", "i", "m", "a"], ["p"]],
    songs: "가족사진 (김진호) — 간주 앞·브리지·후렴",
    note: "엄지가 베이스를 8분음표로 계속 짚고, 1박·2박 반·4박(3+3+2)에 코드를 함께 튕기는 당김 패턴입니다. 「가족사진」 2절 끝(간주 앞)부터 이 모양입니다.",
    extra: true,
  },
];
